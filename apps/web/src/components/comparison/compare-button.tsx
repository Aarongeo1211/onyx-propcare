        ...
        className={`
          ...
          ${
            compared
              ...
              : canAddMore
                ? "bg-onyx-950/60 border-cream/10 text-cream/78 hover:text-gold hover:border-gold/40 hover:bg-gold/10"
                : "bg-onyx-950/60 border-cream/5 text-cream/79 cursor-not-allowed"
          }
        `}
      >
