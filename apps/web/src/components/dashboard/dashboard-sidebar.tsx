    ...
    <aside className="w-[280px] h-screen bg-onyx-900/80 border-r border-cream/5 flex flex-col shrink-0 sticky top-0">
      ...
      <div className="p-4 border-t border-cream/5 space-y-3">
        ...
        <button
          ...
          className="flex items-center gap-3 w-full px-4 py-2.5 rounded-lg text-sm font-medium text-cream/88 hover:text-red-500 hover:bg-red-500/5 transition-all duration-200"
        >
