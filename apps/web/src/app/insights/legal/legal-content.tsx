...
import { legalProcess as legalProcessData } from "./legal-data";
...
const legalProcessIcons = [FileSearch, Scale, Gavel];
const legalProcess = legalProcessData.map((step, i) => ({
  ...step,
  icon: legalProcessIcons[i],
}));
...
export function LegalInsightsPageContent() {
  return (
