    ...
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <span className="text-xs text-cream/40">{suffix}</span>
        </div>
      </div>
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative">
        ...
        />
        {value > 0 && (
          <span className="absolute right-4 top-1/2 -translate-y-1/2 text-xs text-cream/30 font-body">
            {formatPrice(value)}
          </span>
        )}
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-20">
                    ...
                    <button
                      ...
                      className={`flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-body transition-all duration-300 ${
                        propertyType === "farmland"
                          ...
                          : "bg-onyx-800/50 text-cream/40 border border-cream/5 hover:border-cream/10"
                      }`}
                    >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <motion.div variants={fadeUp} custom={4}>
                <Card className="p-5">
                  ...
                  <p className="mt-1 text-xs font-body text-cream/30">
                    Down payment + EMIs
                  </p>
                </Card>
              </motion.div>
              ...
              <Card className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <p className="text-xs font-body text-cream/40 mt-1">
                ...
                <div className="flex items-center gap-6 mt-4 text-xs font-body">
                  <span className="flex items-center gap-1.5">
                    ...
                    <span className="text-cream/40">Property Value</span>
                  </span>
                  <span className="flex items-center gap-1.5">
                    <span className="w-3 h-0.5 bg-cream/40 rounded border-dashed" />
                    <span className="text-cream/40">Total Invested</span>
                  </span>
                  <span className="flex items-center gap-1.5">
                    <span className="w-3 h-0.5 bg-emerald-400 rounded" />
                    <span className="text-cream/40">Rental Income</span>
                  </span>
                </div>
              </Card>
            </motion.div>
              ...
              <Card className="overflow-hidden">
                ...
                >
                  <div>
                    ...
                    <p className="text-xs font-body text-cream/40 mt-0.5">
                    ...
                    <table className="w-full text-sm font-body">
                      <thead>
                        <tr className="border-b border-cream/5">
                          <th className="text-left py-3 text-cream/40 font-medium">
                            Year
                          </th>
                          <th className="text-right py-3 text-cream/40 font-medium">
                            Property Value
                          </th>
                          <th className="text-right py-3 text-cream/40 font-medium">
                            Rental Income
            ...
            <motion.div variants={fadeUp} custom={1}>
              <Card className="p-6 space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <ArrowRight className="w-5 h-5 text-cream/20" />
                ...
                <div className="space-y-2">
                  <label className="text-xs font-body text-cream/40">
                    Target Currency
                  </label>
                  <select
                ...
                <div className="flex items-center justify-between text-xs font-body text-cream/30 pt-2 border-t border-cream/5">
                  <span>
        ...
        >
          <motion.div variants={fadeUp} custom={0} className="mb-10">
            ...
            <p className="text-sm font-body text-cream/40 max-w-xl">
                ...
                <div className="space-y-2">
                  ...
                  <p className="font-display text-xl font-semibold text-cream">
                    {comparisonData.length > 0
                      ...
                      : "—"}{" "}
                    <span className="text-sm text-cream/40 font-body">
                      ROI at 15Y
                    </span>
                  </p>
                </div>
