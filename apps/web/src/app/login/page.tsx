  ...
  return (
    <div className="min-h-screen flex">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          ...
          >
            <div>
              ...
              <div className="text-cream/82 text-sm font-body mt-1">Verified Listings</div>
            </div>
            <div>
              <div className="font-display text-3xl text-gold font-semibold">98%</div>
              <div className="text-cream/82 text-sm font-body mt-1">Clear Titles</div>
            </div>
          </motion.div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-onyx-950 relative">
        ...
        >
          {/* Mobile logo */}
          <motion.div custom={0} variants={fadeUp} className="lg:hidden mb-8 flex justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <motion.div custom={4} variants={fadeUp} className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-sm text-cream/86 font-body">Remember me</span>
              </label>
              <Link
