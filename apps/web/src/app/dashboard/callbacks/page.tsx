      ...
      <div className="p-8">
        {loading ? (
          ...
          <div className="rounded-2xl border border-cream/8 bg-onyx-900/30 p-10 text-center">
            <PhoneCall className="mx-auto h-10 w-10 text-cream/90" />
            <h3 className="mt-4 font-display text-xl text-cream">No callbacks yet</h3>
            <p className="mt-2 text-sm text-cream/81">Callback requests from property pages will appear here.</p>
          </div>
        ) : (
              ...
              >
                <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 text-sm text-cream/84">{callback.phone}</p>
                    <Link
                    ...
                    {callback.note && <p className="mt-3 text-sm text-cream/90">{callback.note}</p>}
                  </div>
